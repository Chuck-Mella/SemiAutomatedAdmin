...
#$AllDomains = @("NAE","NASE","NANW","NASW")
#$AllDomains = @("NASE","NANW","NASW")
#$AllDomains = @("NAE")
#$InstallationsDN = @(@{domain='NAE';server="EUSTA1NEP000002.nae.ds.army.mil";groups=@();},@{domain='NASE';server="RADFA1SEVXD0001.nase.ds.army.mil";groups=@();},@{domain='NANW';server="RADFA1NWVXD0002.nanw.ds.army.mil";groups=@();})
$InstallationsDN = @(@{domain='NAE';server="RADFA1NEVXD0001.nae.ds.army.mil";groups=@();})
...
$OU
		...
		Elseif ($OUName -eq "AESD"){
		}
		Elseif ($OUName -eq "ARMY ERP"){
		}
		Elseif ($OUName -eq "ALTESS"){
		}
		Elseif ($OUName -eq "DISA Apps"){
		}
		Elseif ($OUName -eq "CHRA"){
		}
		Elseif ($OUName -eq "CECOM"){
		}
		Elseif ($OUName -eq "RDECOM"){
		}
		Elseif ($OUName -eq "USACIDC"){
		}
		Elseif ($OUName -eq "SDDC"){
		}
		Elseif ($OUName -eq "ATEC"){
		}
		Elseif ($OUName -eq "NASE BRT"){
		}
		Elseif ($OUName -eq "Safety Center"){
		}
		Elseif ($OUName -eq "STNOSC"){
		}
		Elseif ($OUName -eq "STRICOM"){
		}
		Elseif ($OUName -eq "CECOM Logistics System"){
		}
		Elseif ($OUName -eq "PD DWTS"){
		}
		Elseif ($OUName -eq "2RCC"){
		}
		Elseif ($OUName -eq "AAFES"){
		}
		Elseif ($OUName -eq "ARNORTH"){
		}
		Elseif ($OUName -eq "GFEBS"){
		}
		Elseif ($OUName -eq "PEO MSL&AVN"){
		}
		Elseif ($OUName -eq "InterDomainViewTest"){
		}
		Else
		{
...
$workbook.SaveAs("C:\users\christopher.l.haxton\desktop\scripts\_personal\GetUserCounts.xlsx")
$workbook.Close
$excel.Quit()