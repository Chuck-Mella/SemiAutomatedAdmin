    ...
    function AD
    {
        ...
        if (Get-Module -ListAvailable -Name ActiveDirectory) { Import-Module ActiveDirectory }
        else
        {
            Write-Host "`nOperation aborted. No Active Directory Module found. Run this tool on a Domain Controller.`n" -ForegroundColor Red
            throw "Error"
        }
        ...
        do
        {
            ...
            Write-Host (Dec64 '')
            Write-Host '                 User | Computer | Groups' -ForegroundColor Yellow
            Write-Host (Dec64 '')
            Write-Host '                OnBoarding | OffBoarding' -ForegroundColor Yellow
            Write-Host (Dec64 'DQotLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0NCjIxIC0gT25Cb2FyZGluZyAgfCBDcmVhdGUgbmV3IEFEIFVzZXIgKGZyb20gZXhpc3RpbmcpDQoyMiAtIE9mZkJvYXJkaW5nIHwgRGlzYWJsZSBBRCBVc2Vy')
            ...
            { 
                 ...
                 3 { 
                    ...
                    (Get-ADDomainController -Filter *).Name | Foreach-Object {$null = repadmin /syncall $_ (Get-ADDomain).DistinguishedName /e /A}; Start-Sleep 10; Get-ADReplicationPartnerMetadata -Target "$env:userdnsdomain" -Scope Domain | Select-Object Server, LastReplicationSuccess | Out-Host
