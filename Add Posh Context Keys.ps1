#region - Add Posh Context Keys
    <#
        ...
        $rPath = 'HKCR:\Microsoft.PowerShellScript.1\Shell'
        # Edit w/ISE x86 as admin
            $tPath = "$rPath\PowerShellISEx86_Elevated"
            New-Item -Path $tPath -Force -Name "" #-WhatIf
            Set-ItemProperty -Path $tPath -Name "(Default)" -Type String -Value "Edit with PowerShell ISE (x86) as administrator" #-WhatIf
            Set-ItemProperty -Path $tPath -Name "HasLUAShield" -Type String -Value $null -WhatIf
            Set-ItemProperty -Path $tPath -Name "Icon" -Type String -Value "PowerShell_ISE.exe" #-WhatIf

            New-Item -Path $tPath\Command -Force -Name "" #-WhatIf
            Set-ItemProperty -Path $tPath\Command -Name "(Default)" -Type String -Value "PowerShell -windowstyle hidden -Command \`"Start-Process cmd -ArgumentList '/s,/c,start C:\\WINDOWS\\syswow64\\WindowsPowerShell\\v1.0\\powershell_ise.exe \`"\`"%1\`"\`"'  -Verb RunAs\`"`"" #-WhatIf

            $dotREG = (Dec64 '')

        # REMOVE Edit w/ISE as admin 
            Remove-Item "$rPath\PowerShellISE_Elevated" -Recurse -Force -WhatIf
            $dotREG = (Dec64 'V2luZG93cyBSZWdpc3RyeSBFZGl0b3IgVmVyc2lvbiA1LjAwDQoNClstSEtFWV9DTEFTU0VTX1JPT1RcTWljcm9zb2Z0LlBvd2VyU2hlbGxTY3JpcHQuMVxTaGVsbFxQb3dlclNoZWxsSVNFX0VsZXZhdGVkXQ0K')

        # REMOVE Open w/ISE as admin 
            Remove-Item "$rPath\PowerShellISEx86_Elevated" -Recurse -Force -WhatIf
            $dotREG = (Dec64 'V2luZG93cyBSZWdpc3RyeSBFZGl0b3IgVmVyc2lvbiA1LjAwDQoNClstSEtFWV9DTEFTU0VTX1JPT1RcTWljcm9zb2Z0LlBvd2VyU2hlbGxTY3JpcHQuMVxTaGVsbFxQb3dlclNoZWxsSVNFeDg2X0VsZXZhdGVkXQ0K')

        # Edit w/ISE as admin (Visible w/shift)
            $tPath = "$rPath\PowerShellISE_Elevated"
            New-Item -Path $tPath -Force -Name "" #-WhatIf
            Set-ItemProperty -Path $tPath -Name "(Default)" -Type String -Value "Edit with PowerShell ISE as administrator" #-WhatIf
            Set-ItemProperty -Path $tPath -Name "Extended" -Type String -Value $null #-WhatIf
            Set-ItemProperty -Path $tPath -Name "HasLUAShield" -Type String -Value $null #-WhatIf
            Set-ItemProperty -Path $tPath -Name "Icon" -Type String -Value "PowerShell_ISE.exe" #-WhatIf

            New-Item -Path $tPath\Command -Force -Name "" #-WhatIf
            Set-ItemProperty -Path $tPath\Command -Name "(Default)" -Type String -Value "PowerShell -windowstyle hidden -Command \`"Start-Process cmd -ArgumentList '/s,/c,start PowerShell_ISE.exe \`"\`"%1\`"\`"'  -Verb RunAs\`"`"" #-WhatIf

            $dotREG = (Dec64 '')
        ...
        # Edit w/ISE as admin 
            ...
            $dotREG = (Dec64 '')

        # Edit w/ISE x86 as admin (Visible w/shift)
            $tPath = "$rPath\PowerShellISEx86_Elevated"
            New-Item -Path $tPath -Force -Name "" #-WhatIf
            Set-ItemProperty -Path $tPath -Name "(Default)" -Type String -Value "Edit with PowerShell ISE (x86) as administrator" #-WhatIf
            Set-ItemProperty -Path $tPath -Name "Extended" -Type String -Value $null #-WhatIf
            ...
            New-Item -Path $tPath\Command -Force -Name "" #-WhatIf
            Set-ItemProperty -Path $tPath\Command -Name "(Default)" -Type String -Value "powershell.exe -windowstyle hidden -Command \`"Start-Process cmd -ArgumentList '/s,/c,start C:\\WINDOWS\\syswow64\\WindowsPowerShell\\v1.0\\powershell_ise.exe \`"\`"%1\`"\`"'  -Verb RunAs\`"`"" #-WhatIf

            $dotREG = (Dec64 '')


        #New-Item -Path HKCR:\Microsoft.PowerShellScript.1\Shell\runas -Force -Name "" -PropertyType String
        #New-ItemProperty -Path HKCR:\Microsoft.PowerShellScript.1\Shell\runas -Name "HasLUAShield" -PropertyType String -Value ""
        #Set-ItemProperty -Path HKCR:\Microsoft.PowerShellScript.1\Shell\runas -Name "" -Value "Run with PowerShell (as admin)"
        #Set-ItemProperty -Path HKCR:\Microsoft.PowerShellScript.1\Shell\runas\command -Name "" -Value "powershell -Command \"Start-Process PowerShell -Verb runas -ArgumentList '-File', '%1'\""
...
#region - ContextMenuFixes(Inwork).ps1
New-PSDrive -PSProvider Registry -Name HKCR -Root HKEY_CLASSES_ROOT
$rPath = 'HKCR:\Microsoft.PowerShellScript.1\Shell'
# Edit w/ISE x86 as admin
    $tPath = "$rPath\PowerShellISEx86_Elevated"
