function Get-Baseline {
	...
	if (-Not $SkipEventLogSettings) {
		...
		Invoke-Command -ComputerName $PSTargets -ScriptBlock {Get-EventLog -list | Select-Object LogDisplayName,Log,MachineName,MaximumKilobytes,OverflowAction,MinimumRetentionDays,EnableRaisingEvent,SynchronizingObject,Source,Site,Container
	...
	Invoke-Command -ComputerName $PSTargets -ScriptBlock {Get-Content $((Get-PSReadlineOption).HistorySavePath)} | Export-Csv ./Baseline/PowerShellHistory.csv -NoTypeInformation
...
function Get-BetterTasklist {
	...
	$betterPsList = Get-WmiObject -Class Win32_process `
		| Select-Object -property Name,ProcessID,ParentProcessId,ExecutablePath,CommandLine `
		| ForEach-Object {
	...
	$betterPsList | Select-Object TimeGenerated,Name,ProcessID,ParentProcessId,ExecutablePath,SHA_1,CommandLine
}
...
function Get-DLLs {
	...
	$results | Select-Object TimeGenerated,ModuleName,FileName,SHA_1,Size,Company,Description,FileVersion,Product,ProductVersion
}
...
function Get-BetterNetstatTCP {
	...
	$betterNetstat | Select-Object TimeGenerated,Protocol,LocalAddressIP,LocalAddressPort,ForeignAddressIP,ForeignAddressPort,State,Name,ProcessId,ParentProcessId,ExecutablePath,SHA_1,CommandLine
}
...
function Get-BetterNetstatTCPv6 {
	...
	$betterNetstat | Select-Object TimeGenerated,Protocol,LocalAddress,ForeignAddress,State,Name,ProcessId,ParentProcessId,ExecutablePath,SHA_1,CommandLine
}
...
function Get-BetterNetstatUDP {
	...
	$betterNetstat | Select-Object TimeGenerated,Protocol,LocalAddressIP,LocalAddressPort,Name,ProcessId,ParentProcessId,ExecutablePath,SHA_1,CommandLine
}
...
function Get-BetterNetstatUDPv6 {
	...
	$betterNetstat | Select-Object TimeGenerated,Protocol,LocalAddress,Name,ProcessId,ParentProcessId,ExecutablePath,SHA_1,CommandLine
}
